...
gcc -o ssl_client ssl_client.c -I$OPENSSL102/include -L$OPENSSL102 -lssl -lcrypto -ldl -lpthread
gcc -o ssl_server ssl_server.c -I$OPENSSL102/include -L$OPENSSL102 -lssl -lcrypto -ldl -lpthread
```
